    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < m; i++) {
            ...
            if (command.equals("recommend")) {
                ...
                int pos = sc.nextInt();
                if (pos == 1) {
                   sb.append(algoTreeSet.get(n_algo).last().idx + "\n");
                } else {
                 sb.append(algoTreeSet.get(n_algo).first().idx + "\n");
                }
                ...
                if (pos == 1) {
                    ...
                    sb.append(ts.ceiling(new Problem(0, stand, 0)).idx+ "\n");
                    }
                } else {
                    if (ts.floor(new Problem(0, stand, 0)) == null) {
                       sb.append(-1+ "\n");
                    } else {
                    sb.append(ts.floor(new Problem(0, stand, 0)).idx+ "\n");
                    }
                }
